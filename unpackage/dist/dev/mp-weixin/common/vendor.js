...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__4121800" };exports.default = _default;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.String2Ab = String2Ab;exports.Ab2String = Ab2String;exports.sleep = sleep;exports.isNeedVersion = isNeedVersion;exports.closeBle = closeBle;exports.connectBle = connectBle; //16进制字符串转2进制
...
//二进制转16进制字符串
function Ab2String(arr) {
  var view = new DataView(arr);
  var str = "";
  for (var i = 0; i < arr.byteLength; i++) {
    var tmp = view.getUint8(i).toString(16);
    if (tmp.length == 1) {
      tmp = "0" + tmp;
    }
    str += tmp;
...
function isNeedVersion(phoneType, searchedVersion) {
  var androidNeedVersion = 657;
  var iosNeedVersion = 656;

  if (phoneType == 'android') {
    var varr = searchedVersion.split('.');
    var vm1 = parseInt(varr.join(''));
    return vm1 > androidNeedVersion;

  } else if (phoneType == 'ios') {
    var _varr = searchedVersion.split('.');
    var _vm = parseInt(_varr.join(''));
    return _vm > iosNeedVersion;
  }
}
...
var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //引入vue和vuex
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setversionRight: function setversionRight(state, versionRight) {
      state.versionRight = versionRight;
    },
    //设置服务id
    setOpenLocation: function setOpenLocation(state, status) {
    ...
    //设置设备的imei
    setDeviceImei: function setDeviceImei(state, deviceImei) {
      state.deviceImei = deviceImei;
    },
    //设置查询出来的设备id
    setDeviceId: function setDeviceId(state, deviceId) {
      state.deviceId = deviceId;
    },
    //设备设备真实名字
    setDeviceName: function setDeviceName(state, deviceName) {
      state.deviceName = deviceName;
    },
    //设置商品数组
    setGoodsObjectArray: function setGoodsObjectArray(state, goodsObjectArray) {
      state.goodsObjectArray = goodsObjectArray;
    },
    //设置提交商品数组
    setCommitGoodsArray: function setCommitGoodsArray(state, commitGoodsArray) {
      state.commitGoodsArray = commitGoodsArray;
    },
    //设置运营商对象
    setMachObject: function setMachObject(state, machObject) {
      state.machObject = machObject;
    },
    //设置检查在线命令
    setCheckOnlineOrder: function setCheckOnlineOrder(state, checkOnlineOrder) {
      state.checkOnlineOrder = checkOnlineOrder;
    },
    //设置确认命令
    setConfirmOrder: function setConfirmOrder(state, confirmOrder) {
      state.confirmOrder = confirmOrder;
    },
    //设置优惠券开启状态
    setVoucherState: function setVoucherState(state, voucherState) {
      state.voucherState = voucherState;
    },
    //设置手机蓝牙功能是否开启
    setBlueToothOpen: function setBlueToothOpen(state, blueToothOpen) {
